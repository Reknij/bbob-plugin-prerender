...
Use command:
```
bbob add -a https://github.com/Reknij/bbob-plugin-prerender/releases/download/v1.4.0/bbob-plugin-prerender.rar
```
Please change 'v1.4.0' to you expect version for install in address.
